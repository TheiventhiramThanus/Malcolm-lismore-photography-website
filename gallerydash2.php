...
if(isset($_POST["insert"])) {
    ...
    if ($file['error'] == 0) {
        ...
        $query = "INSERT INTO gallery2 (img) VALUES ('$imgData')";  // Updated table name
...
if(isset($_POST["edit"])) {
    ...
    if ($file['error'] == 0) {
        ...
        $stmt = $link->prepare("UPDATE gallery2 SET img = ? WHERE id = ?");  // Updated table name
...
if(isset($_POST["delete"])) {
    $imgId = $_POST["img_id"];
    $query = "DELETE FROM gallery2 WHERE id='$imgId'";  // Updated table name
    if(mysqli_query($link, $query)) {
...
// Fetch all images from the gallery2 table
$result = mysqli_query($link, "SELECT id, img FROM gallery2");  // Updated table name
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="dashboard">
        ...
        <div class="main-content">
            <header class="navbar">
               <h3 style="margin-left: 450px;">Nature Gallery</h3>
            </header>
            <div class="content">
