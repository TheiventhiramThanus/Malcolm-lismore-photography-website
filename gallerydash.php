...
if(isset($_POST["insert"])) {
    ...
    if ($file['error'] == 0) {
        ...
        if (strpos($fileType, 'image/') === false) {
            ...
            $query = "INSERT INTO gallery (img) VALUES ('$imgData')";
...
if(isset($_POST["edit"])) {
    ...
    if ($file['error'] == 0) {
        ...
        if (strpos($fileType, 'image/') === false) {
            ...
            $imgData = addslashes(file_get_contents($file['tmp_name']));
            $stmt = $link->prepare("UPDATE gallery SET img = ? WHERE id = ?");
...
if(isset($_POST["delete"])) {
    $imgId = $_POST["img_id"];
    $query = "DELETE FROM gallery WHERE id='$imgId'";
    if(mysqli_query($link, $query)) {
...
$result = mysqli_query($link, "SELECT id, img FROM gallery");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="dashboard">
        <aside class="sidebar">
            ...
            <ul>
                ...
                <li class="dropdown">
                    <h2 style="margin-left: 1.5cm;">Gallery</h2>
                    <ul>
                        
                        <li id="gallery2">Nature Gallery</li>
                        <li id="gallery3">Event Gallery</li>
                        <li id="gallery4">Fashion Gallery</li>
                    </ul>
                </li>
            </ul>
        </aside>
        <div class="main-content">
            <header class="navbar">
                <h3 style="margin-left: 450px;">Wedding Gallery</h3>
            </header>
            <div class="content">
                <div class="card-container">
                    <div class="card">
                        <form action="" method="post" enctype="multipart/form-data">
                            <input name="img" type="file" accept="image/jpeg" required>
                    ...
                    <div class="card">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <input type="file" name="img_update" class="hidden-file-input" accept="image/jpeg" onchange="this.form.submit();">
