...
if(isset($_POST["insert"])) {
    ...
    if ($file['error'] == 0) {
        ...
        $query = "INSERT INTO gallery3 (img) VALUES ('$imgData')";  // Updated table name
...
if(isset($_POST["edit"])) {
    ...
    if ($file['error'] == 0) {
        ...
        $stmt = $link->prepare("UPDATE gallery3 SET img = ? WHERE id = ?");  // Updated table name
...
if(isset($_POST["delete"])) {
    $imgId = $_POST["img_id"];
    $query = "DELETE FROM gallery3 WHERE id='$imgId'";  // Updated table name
    if(mysqli_query($link, $query)) {
...
// Fetch all images from the gallery3 table
$result = mysqli_query($link, "SELECT id, img FROM gallery3");  // Updated table name
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="dashboard">
        ...
        <div class="main-content">
            <header class="navbar">
               <h3 style="margin-left: 450px;">Event Gallery</h3>
            </header>
            <div class="content">
